  ...
  return (
    ...
    >
      ...
      <div className='px-4 py-3 flex justify-between items-center bg-transparent relative z-10'>
        <h3 className='text-sm font-medium text-zinc-400 group-hover:text-white transition-colors'>{title}</h3>
        ...
        <section>
          <div className='mb-12'>
            <h2 className='text-white text-3xl font-bold flex items-center gap-3'>
              Out of the box <span className='text-zinc-500 font-normal text-lg'>[06]</span>
            </h2>
            <p className='text-zinc-500 text-sm mt-2'>Collection of interactive components [Click to view]</p>
          </div>

          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 auto-rows-[280px]'>
            
            <Link href="/component/image-reveal" className="block">
              <ComponentCard title='Image reveal' author='skiper1' videoSrc='/videos/reveal-demo.mp4' />
            </Link>

            <Link href="/component/hover-members" className="lg:col-span-2">
              <ComponentCard title='Hover members' author='skiper2' videoSrc='/videos/members-demo.mp4' />
            </Link>

            <Link href="/component/drag-scroll" className="lg:row-span-2">
              <ComponentCard title='Things drag and scroll' author='skiper3' videoSrc='/videos/drag-demo.mp4' />
            </Link>
            ...
            <Link href="/component/devouring-details" className="lg:col-span-2">
              <ComponentCard title='Devouring details' author='skiper5' videoSrc='/videos/details-demo.mp4' />
            </Link>

            <Link href="/component/scrollbar" className="block">
              <ComponentCard title='Anime js scrollbar' author='skiper6' videoSrc='/videos/scrollbar.mp4' />
            </Link>
