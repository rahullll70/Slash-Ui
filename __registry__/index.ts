...
export const Index: Record<string, any> = {
  default: {
    'neubrutal-button': {
      ...
      type: 'components:ui',
      component: React.lazy(() => import('@/registry/ui/3d-button')),
      files: ['registry/ui/3d-button.tsx'],
      category: 'Buttons',
...
export const NeubrutalButton = ({ children, className,...props }: NeubrutalButtonProps) => {
      return (
    <button
      {...props}
      className={cn(
    ...
    >
      ...
      {/* The Bottom Layer (Side of the button) */}
      ...
      {/* The Top Layer (Face of the button) */}
      <div className="
        relative w-full h-full flex items-center justify-center
        bg-[#ffffee] rounded-[7mm] outline outline-2 outline-[#242622]
        text-[#242622] font-semibold text-base overflow-hidden
        transition-all duration-200
        group-active:translate-y-[10px]
      ">
        {/* Shine Animation Effect */}
        <div className="
          absolute top-0 -left-[20px] w-[15px] h-full bg-black/10 skew-x-[30deg] 
          transition-all duration-300 group-active:left-[calc(100%+20px)]
        " />
        {children}
      </div>
    </button>
