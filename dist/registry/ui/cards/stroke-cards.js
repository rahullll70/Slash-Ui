...
const CARDS = [
    {
        ...
        titleLine1: 'burnt',
        titleLine2: 'archive',
        imageSrc: 'https://i.pinimg.com/1200x/4e/e6/c9/4ee6c989f3730be8194e41ceb8799583.jpg',
        strokeColor: '#192124',
    },
    {
        id: 'card-2',
        titleLine1: 'chrome',
        titleLine2: 'reverie',
        imageSrc: 'https://i.pinimg.com/736x/05/8d/8a/058d8a92f4a405470ffdcc0a1741e3a0.jpg',
        strokeColor: '#eb3828',
    },
    {
        id: 'card-3',
        titleLine1: 'dust',
        titleLine2: 'memory',
        imageSrc: 'https://i.pinimg.com/1200x/53/01/5a/53015a37d8a9b71ed5603430e20df4f3.jpg',
        strokeColor: '#27333F',
    },
    {
        id: 'card-4',
        ...
        imageSrc: 'https://i.pinimg.com/1200x/4e/e4/c2/4ee4c269a5308e0c82fbf05ef6150317.jpg',
        strokeColor: '#5f7c98',
    },
];
// ─── Card Component ───────────────────────────────────────────────────────────
function HoverCard({ card }) {
    ...
    useEffect(() => {
        ...
        if (!el)
            return;
        const paths = el.querySelectorAll('.svg-stroke path');
        ...
        const onEnter = () => {
            ...
            tl.to(wordInners, { yPercent: 0, duration: 0.75, ease: 'power3.out', stagger: 0.075 }, 0.35);
        };
        const onLeave = () => {
            if (tlRef.current)
                tlRef.current.kill();
    ...
    return (_jsxs("div", { ref: cardRef, id: card.id, className: 'relative w-full rounded-2xl overflow-hidden cursor-pointer', style: { aspectRatio: '1 / 1' }, children: [_jsx("img", { src: card.imageSrc, alt: card.titleLine1, className: 'absolute inset-0 w-full h-full object-cover' }), _jsx("div", { className: 'svg-stroke absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 scale-150 w-full h-full pointer-events-none', style: { '--stroke-color': card.strokeColor }, children: _jsx("svg", { xmlns: 'http://www.w3.org/2000/svg', viewBox: '0 0 375 259', className: 'w-full h-full', children: _jsx("g", { transform: 'translate(346 215.99999999999994) rotate(0 -158.5 -86.49999999999994)', children: _jsx("path", { d: SWIRL_PATH, fill: 'none', stroke: card.strokeColor, strokeWidth: 2 }) }) }) }), _jsx("div", { className: 'svg-stroke absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 scale-150 w-full h-full pointer-events-none', children: _jsx("svg", { xmlns: 'http://www.w3.org/2000/svg', viewBox: '0 0 330 301', className: 'w-full h-full', children: _jsx("g", { transform: 'translate(177 289) rotate(0 -12 -138.5)', children: _jsx("path", { d: SPIRAL_PATH, fill: 'none', stroke: '#e0e0e0', strokeWidth: 2 }) }) }) }), _jsx("div", { className: 'absolute bottom-8 left-8 text-black max-md:bottom-4 max-md:left-4', children: _jsxs("h3", { className: 'font-medium leading-tight tracking-tight', style: {
                        fontSize: 'clamp(1.5rem, 2.5vw, 3rem)',
                        letterSpacing: '-0.025rem',
                    }, children: [_jsx("span", { className: 'overflow-hidden inline-block', children: _jsx("span", { className: 'word-inner inline-block', children: card.titleLine1 }) }), ' ', _jsx("span", { className: 'overflow-hidden inline-block', children: _jsx("span", { className: 'word-inner inline-block', children: card.titleLine2 }) })] }) })] }));
}
// ─── Main Page Component ──────────────────────────────────────────────────────
export default function HoverStatePage() {
    ...
    return (_jsxs("main", { className: 'bg-white h-screen w-full', style: { fontFamily: "'Google Sans', sans-serif" }, children: [_jsx("style", { children: `@import url('https://fonts.googleapis.com/css2?family=Google+Sans:ital,opsz,wght@0,17..18,400..700;1,17..18,400..700&display=swap');` }), _jsx("header", { className: 'w-full flex items-center justify-center text-center px-8', children: _jsx("h1", { className: 'font-medium leading-tight tracking-tight text-5xl py-10', children: "The Hover State" }) }), _jsx("div", { className: 'w-full max-w-7xl mx-auto space-y-4 px-4 py-10', children: rows.map((row, i) => (_jsx("div", { className: 'grid grid-cols-2 gap-4 max-md:grid-cols-1', children: row.map((card) => (_jsx(HoverCard, { card: card }, card.id))) }, i))) })] }));
}
