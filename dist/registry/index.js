        ...
        interactionType: [
            {
                ...
                description: 'Uses stacked, absolute-positioned div elements to simulate a physical, multi-layered "Neubrutalist" shadow effect.',
            },
            {
                type: 'Mechanical Click Depression',
                description: 'Implements dual-phase translation (via active/group-active) to simulate a physical mechanical button press.',
            },
            {
                type: 'Active Glare Swipe',
                description: 'Triggers a skewed div overlay that slides across the button surface on click, providing an animated visual "glare" feedback.',
            },
        ],
  ...
  return (
        ...
        interactionType: [
            {
                ...
                description: 'Uses GSAP interpolation with custom easing to create a fluid, lagging follow effect on mouse movement.',
            },
            {
                type: 'Visual Blend Mode',
                description: 'Utilizes CSS mix-blend-difference to dynamically invert background colors for high-contrast visibility.',
            },
            {
                type: 'Responsive Visibility',
                description: 'Automatically hides the element on mobile devices (screens < 768px) to preserve touch-device UX.',
            },
            {
                type: 'Non-blocking UX',
                description: 'Implements pointer-events-none to ensure the custom cursor does not interfere with clicking or hovering on page elements.',
            },
        ],
    ...
    },
    {
        ...
        interactionType: [
            ...
            {
                type: 'Audio Toggle',
                description: 'Interactive button that plays/pauses ambient audio with visual feedback.',
            },
            {
                type: 'Staggered Hover',
                description: 'Letter-by-letter vertical scramble animation on navigation links.',
            },
            {
                type: 'Path Detection',
                description: 'Automatically highlights the active route with an animated underline.',
            },
        ],
        ...
        interactionType: [
            {
                ...
                description: 'Maps the document scroll position to a percentage-based vertical translation of the thumb.',
            },
            {
                type: 'Performance-Optimized Renders',
                description: 'Uses requestAnimationFrame and passive event listeners to ensure smooth performance without main-thread blocking.',
            },
            {
                type: 'Responsive Geometry',
                description: 'Calculates track dimensions and offsets dynamically on resize to accommodate layout changes.',
            },
        ],
        ...
        interactionType: [
            {
                ...
                description: 'Uses the ::after pseudo-element with a cubic-bezier transition to sweep a horizontal strike-through line across the component.',
            },
            {
                type: 'Text Mask Reveal',
                description: 'Utilizes the ::before pseudo-element and the data-letters attribute to trigger a width-based mask reveal of the colored text on hover.',
            },
            {
                type: 'Fluid Typography',
                description: 'Implements the clamp() function to ensure responsive text scaling across diverse viewport widths while maintaining aspect ratios.',
            },
        ],
        ...
        interactionType: [
            {
                ...
                description: 'Implements a physics-based velocity engine using requestAnimationFrame, allowing for smooth momentum-based scrolling with mouse and touch inputs.',
            },
            {
                type: 'Vertex Distortion Effect',
                description: 'Calculates scroll velocity to dynamically manipulate plane geometry vertices in real-time, creating a physical "stretch" or "bend" distortion effect.',
            },
            {
                type: 'Infinite Looping Logic',
                description: 'Manages a modular wrapping system that recycles 3D planes seamlessly, allowing for an endless vertical gallery without performance degradation.',
            },
            {
                type: 'Active State Synchronization',
                description: 'Continuously tracks the 3D element closest to the viewport center and maps it to the 2D UI components (title and counter) in real-time.',
            },
        ],
        ...
        interactionType: [
            {
                ...
                description: 'Calculates path length via SVG API and uses GSAP to animate stroke-dashoffset, creating a "drawing" effect on hover.',
            },
            {
                type: 'Layered Motion Reveal',
                description: 'Coordinates simultaneous trigger of CSS properties and SVG stroke widths for a multi-layered design transition.',
            },
            {
                type: 'GSAP Timeline Orchestration',
                description: 'Manages conflicting enter/leave states by killing existing timelines, ensuring smooth state transitions without animation "glitching".',
            },
        ],
        ...
        interactionType: [
            {
                ...
                description: 'Implements custom velocity-based inertia using requestAnimationFrame and linear interpolation (LERP).',
            },
            {
                type: 'Arc Projection',
                description: 'Calculates dynamic transform matrix (scale, opacity, Y-position) to map elements onto a parabolic curve.',
            },
            {
                type: 'State Sync',
                description: 'Real-time calculation of viewport proximity to trigger active slide state.',
            },
        ],
        ...
        interactionType: [
            {
                ...
                description: 'Uses SplitType to manipulate character-level DOM nodes for high-end micro-interactions.',
            },
            {
                type: 'Hybrid Trigger Logic',
                description: 'Conditional mapping of GSAP timelines to ScrollTrigger states: Immediate, Viewport-Enter, and Scrubbed.',
            },
        ],
