...
export default function LoginPage() {
    ...
    return (_jsxs("div", { className: 'min-h-screen flex flex-col items-center justify-center text-white px-4 font-sans selection:bg-zinc-800', children: [_jsx(ToastContainer, {}), _jsx("div", { className: 'w-full max-w-2xl', children: step === 'email' ? (_jsxs("form", { onSubmit: async (e) => {
                        var _a;
                        e.preventDefault();
                        setLoading(true);
                        try {
                            ...
                            if ((err === null || err === void 0 ? void 0 : err.message) === 'NEXT_REDIRECT' ||
                                ((_a = err === null || err === void 0 ? void 0 : err.digest) === null || _a === void 0 ? void 0 : _a.startsWith('NEXT_REDIRECT'))) {
                                throw err;
                            }
