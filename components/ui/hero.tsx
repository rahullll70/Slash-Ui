  ...
  return (
    ...
    >
      ...
      <div className='relative z-10 container mx-auto px-6 flex mt-40 flex-col items-center'>
        {/* Adjusted: Added flex flex-col items-center and a negative gap (vertical spacing) */}
        <h1 className='max-w-4xl text-center text-4xl tracking-tight md:text-7xl text-white flex flex-col items-center -space-y-2 md:-space-y-5'>
          <span className='block overflow-hidden pb-1 leading-none font-semibold'>
            {splitText('Slash/Ui')}
          </span>
          <span className='block overflow-hidden pt-1 leading-none'>
